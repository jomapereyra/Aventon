...
-- Tiempo de generación: 12-05-2018 a las 04:14:27
...
INSERT INTO `localidad` (`id_localidad`, `id_privincia`, `nombre_localidad`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
CREATE TABLE IF NOT EXISTS `ubicacion` (
  ...
  `nombre_provincia` varchar(120) CHARACTER SET utf8 NOT NULL,
  `nombre_ciudad` varchar(120) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`calle`,`numero`,`nombre_provincia`,`nombre_ciudad`)
